        ...
        <div className="mt-[8rem]  mb-20">
          <div className="flex flex-col gap-10">
            <div className="flex flex-col lg:flex-row gap-10">
              <div className="flex-1 p-8 rounded-lg shadow-lg text-[#4D4D4d] w-full lg:w-[30%]">
            ...
            <div className="bg-[linear-gradient(to_top_right,_#f48221_50%,_#faa749_95%)] text-[#ffffff] flex-1 shadow-lg p-8 rounded w-full mx-0 lg:w-[50%] lg:mx-auto">
